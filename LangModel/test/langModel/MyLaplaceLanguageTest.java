...
public class MyLaplaceLanguageTest {
    ...
    public void testGetNgramProb() {
        ...
        assertEquals((double)2/22, (double) nlm.getNgramProb("Ce cours"), 0.001);//delta =precision
        assertEquals((double)0, (double) nlm.getNgramProb("poule"), 0.001);
        assertEquals((double)1/22, (double) nlm.getNgramProb("Ce genial"), 0.001);
    }
